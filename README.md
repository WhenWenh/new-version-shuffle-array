# @untitledq/new-version-shuffle-aary
...
```bash
npm install @untitledq/new-version-shuffle-aary
```
Install via yarn:

```bash
yarn add @untitledq/new-version-shuffle-aary
```
...
```js
import shuffleArray from '@untitledq/new-version-shuffle-aary';
